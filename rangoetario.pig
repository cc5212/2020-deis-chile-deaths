...
ninhos_causa_ordered = FOREACH (GROUP ninhos ALL) GENERATE COUNT(ninhos) as ninhos_total; --(total_ninhos) 
...
ninhos_final = CROSS ninhos_causa_ordered, max_ninhos_causa;


adolescentes = FILTER anho_edad BY (edad_cant >=12) AND (edad_cant < 18);
adolescentes_causa_ordered = FOREACH (GROUP adolescentes ALL) GENERATE COUNT(adolescentes) as adolescentes_total; --(total_adolescentes) 
...
adolescentes_final = CROSS adolescentes_causa_ordered, max_adolescentes_causa;


adulto_joven = FILTER anho_edad BY (edad_cant >= 18) AND (edad_cant < 30);
adulto_joven_causa_ordered = FOREACH (GROUP adulto_joven ALL) GENERATE COUNT(adulto_joven) as adulto_joven_total; --(total_adulto_joven) 
...
adulto_joven_final = CROSS adulto_joven_causa_ordered, max_adulto_joven_causa;


adultos = FILTER anho_edad BY (edad_cant >= 30) AND (edad_cant < 50);
adultos_causa_ordered = FOREACH (GROUP adultos ALL) GENERATE COUNT(adultos) as adultos_total; --(total_adultos) 
...
adultos_final = CROSS adultos_causa_ordered, max_adultos_causa;


adulto_no_tan_mayor = FILTER anho_edad BY (edad_cant >= 50) AND (edad_cant < 65);
adulto_no_tan_mayor_causa_ordered = FOREACH (GROUP adulto_no_tan_mayor ALL) GENERATE COUNT(adulto_no_tan_mayor) as adulto_no_tan_mayor_total; --(total_adulto_no_tan_mayor) 
...
adulto_no_tan_mayor_final = CROSS adulto_no_tan_mayor_causa_ordered, max_adulto_no_tan_mayor_causa;


adultos_mayor = FILTER anho_edad BY (edad_cant >= 65);
adultos_mayor_causa_ordered = FOREACH (GROUP adultos_mayor ALL) GENERATE COUNT(adultos_mayor) as adultos_mayor_total; --(total_adultos_mayor) 
...
adultos_mayor_final = CROSS adultos_mayor_causa_ordered, max_adultos_mayor_causa;


STORE ninhos_final INTO '/uhadoop2020/patosdepana/results/ninhos/';
STORE adolescentes_final INTO '/uhadoop2020/patosdepana/results/adolescentes/';
STORE adulto_joven_final INTO '/uhadoop2020/patosdepana/results/adulto_joven/';
STORE adultos_final INTO '/uhadoop2020/patosdepana/results/adultos/';
STORE adulto_no_tan_mayor_final INTO '/uhadoop2020/patosdepana/results/adultos_no_tan_mayor/';
STORE adultos_mayor_final INTO '/uhadoop2020/patosdepana/results/adultos_mayor/';